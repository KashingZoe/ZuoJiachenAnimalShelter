...
<div class="weadmin-body">
    <div class="layui-row">
        <form:form action="adminNews/selectANews" modelAttribute="news" method="post" class="layui-form layui-col-md12 we-search">
            新闻搜索：
    ...
    <table class="layui-table" id="memberList">
        ...
        <tr data-id="1">
            ...
            <td class="td-manage">
                <button class="layui-btn" onclick="WeAdminEdit('编辑','adminNews/toEditNews?id=${n.id}',600, 400)">
    ...
    <div class="page" id="hide">
        <div>
            <c:url var="url_pre" value="/adminNews/newsInfo">
                <c:param name="pageCur" value="${pageCur - 1 }"/>
            </c:url>
            <c:url var="url_next" value="/adminNews/newsInfo">
                <c:param name="pageCur" value="${pageCur + 1 }"/>
            </c:url>
