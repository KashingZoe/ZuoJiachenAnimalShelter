...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">${auser.aname}</a>
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="adminUser/userInfo" target="center">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="adminFeedback/feedbackInfo">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>留言列表</cite>
                        </a>
                    </li>
    ...
    <div class="layui-tab tab" lay-filter="wenav_tab" id="WeTabTip" lay-allowclose="true">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src="admin/welcome" name="center" frameborder="0" scrolling="yes" class="weIframe"></iframe>
            </div>
        </div>
    </div>
</div>
