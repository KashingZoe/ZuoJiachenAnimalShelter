...
<div class="weadmin-body">
    <form:form class="layui-form" action="adminUser/editUser" method="post" modelAttribute="buser" name="regForm">
        <div class="layui-form-item">
            <label for="L_ID" class="layui-form-label">ID</label>
            <div class="layui-input-inline">
                <form:input type="text" id="L_ID" path="id" name="id" lay-verify="email" autocomplete="off" class="layui-input"/>
            </div>
        ...
        <div class="layui-input-inline">
            <form:input type="text" id="L_email" path="bemail" name="bemail" lay-verify="email" autocomplete="off" class="layui-input"/>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <form:input type="text" id="L_username" path="bname" name="bname"  lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <form:input type="password" id="L_pass" path="bpwd" name="bpwd"  lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <form:input type="text" id="L_qq" path="bqq" name="bqq" lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_wechat" class="layui-form-label">微信</label>
            <div class="layui-input-inline">
                <form:input type="text" id="L_wechat" path="bwechat" name="bwechat"   lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_tel" class="layui-form-label">电话</label>
            <div class="layui-input-inline">
                <form:input type="text" id="L_tel" path="btel" name="btel"  lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="city" class="layui-form-label">地区</label>
            <div class="layui-input-inline">
                <div class="wrap"><form:input class="layui-input" path="barea" name="barea" id="city" type="text" placeholder="请选择" autocomplete="off" readonly="true"/><s></s></div>
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_add" class="layui-form-label">详细地址</label>
            <div class="layui-input-inline">
                <form:input type="text" id="L_add" path="badd" name="badd"  lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                 <button class="layui-btn" onclick="checkForm()" lay-filter="*" lay-submit>修改用户</button>
            </div>
        </div>
    </form:form>
</div>
