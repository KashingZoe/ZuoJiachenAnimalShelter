...
<div class="weadmin-body">
    <form:form class="layui-form" action="adminNews/addNews" method="post" modelAttribute="news" name="regForm" enctype="multipart/form-data">


        <div class="layui-form-item">
            <label for="L_ntitle" class="layui-form-label">标题</label>
            <div class="layui-input-inline">
                <input type="text" id="L_ntitle" path="ntitle" name="ntitle" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <form:textarea path="ncontent" placeholder="请输入内容" class="layui-textarea"  id="L_ncontent" name="L_ncontent" lay-verify="required" autocomplete="off"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                 <button class="layui-btn" type="submit" lay-filter="*" lay-submit>添加新闻</button>
            </div>
        </div>
    </form:form>
</div>
