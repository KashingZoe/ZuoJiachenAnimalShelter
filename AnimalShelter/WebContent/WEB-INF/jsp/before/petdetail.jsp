        ...
        <div class="layui-col-md8 content detail">
            <div class="fly-panel detail-box">
                ...
                <div class="detail-about">
                    ...
                    <img alt="" width="585px" height="350px" src="logos/${petList.ppicture}"/>
                </div>
                    ...
                    <div class="detail-about" style="padding-left: 0px;color: #000000;">
                        <form class="layui-form" action="" style="margin-left: 0px;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block mytb">
                                    <div class="layui-form-mid layui-word-aux mymid">${petList.bname}</div>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block mytb">
                                    <div class="layui-form-mid layui-word-aux mymid">${petList.bqq}</div>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block mytb">
                                    <div class="layui-form-mid layui-word-aux mymid">${petList.bwechat}</div>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block mytb">
                                    <div class="layui-form-mid layui-word-aux mymid">${petList.btel}</div>
                                </div>
                            </div>
